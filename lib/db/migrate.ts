...
async function seedIfEmpty() {
  ...
  const seedCourses = [
    {
      id: "web-dev", title: "The Complete Web Development Bootcamp",
      instructor: "Sarah Mitchell", category: "Development",
      shortDescription: "Go from zero to full-stack developer with HTML, CSS, JavaScript, and React.",
      description: "Master modern web development from the ground up. Covers HTML5, CSS3, JavaScript ES6+, React, and backend fundamentals.",
      price: 1299, thumbnail: "/courses/web-development.png", rating: 4.8, students: 12840,
      level: "Beginner" as const, duration: "28h 15m",
      chaptersData: [
    ...
    {
      id: "data-science", title: "Data Science & Machine Learning A-Z",
      instructor: "Dr. Raj Patel", category: "Data Science",
      shortDescription: "Learn Python, statistics, and ML models with real-world datasets.",
      description: "Dive into the world of data science. Covers data wrangling with Pandas, visualization, and ML models with scikit-learn.",
      price: 1799, thumbnail: "/courses/data-science.png", rating: 4.7, students: 9320,
      level: "Intermediate" as const, duration: "19h 45m",
      chaptersData: [
    ...
    {
      id: "ui-ux", title: "UI/UX Design Masterclass",
      instructor: "Elena Rodriguez", category: "Design",
      shortDescription: "Design beautiful, user-friendly interfaces with Figma.",
      description: "Become a confident product designer. Teaches design principles, wireframing, prototyping in Figma, and design systems.",
      price: 999, thumbnail: "/courses/ui-ux-design.png", rating: 4.9, students: 7610,
      level: "Beginner" as const, duration: "16h 05m",
      chaptersData: [
    ...
    {
      id: "marketing", title: "Digital Marketing Complete Guide",
      instructor: "Marcus Lee", category: "Marketing",
      shortDescription: "SEO, social media, email, and paid ads that drive growth.",
      description: "A complete digital marketing course covering SEO, content marketing, social media, email campaigns, and paid advertising.",
      price: 899, thumbnail: "/courses/digital-marketing.png", rating: 4.6, students: 5430,
      level: "Beginner" as const, duration: "11h 45m",
      chaptersData: [
    ...
    {
      id: "python", title: "Python Programming for Everybody",
      instructor: "Aisha Khan", category: "Development",
      shortDescription: "Start coding with Python — the world's most popular language.",
      description: "Learn Python from scratch. Covers syntax, data structures, functions, file handling, and automation.",
      price: 799, thumbnail: "/courses/python.png", rating: 4.8, students: 18200,
      level: "Beginner" as const, duration: "14h 25m",
      chaptersData: [
    ...
    {
      id: "photography", title: "Photography Fundamentals",
      instructor: "James Carter", category: "Photography",
      shortDescription: "Master your camera and capture stunning photos.",
      description: "Learn exposure, composition, lighting, and post-processing for DSLR, mirrorless, and smartphone cameras.",
      price: 699, thumbnail: "/courses/photography.png", rating: 4.7, students: 4120,
      level: "Beginner" as const, duration: "9h 10m",
      chaptersData: [
  ...
  for (const c of seedCourses) {
    ...
    for (let ci = 0; ci < c.chaptersData.length; ci++) {
      ...
      const chId = uid("ch")
      await db.insert(chapters).values({ id: chId, courseId: c.id, title: ch.title, position: ci })
      for (let li = 0; li < ch.lessons.length; li++) {
        const [lt, ld] = ch.lessons[li] as [string, string]
        await db.insert(lessons).values({ id: uid("l"), chapterId: chId, title: lt, duration: ld, position: li })
      }
    }
  }
}
